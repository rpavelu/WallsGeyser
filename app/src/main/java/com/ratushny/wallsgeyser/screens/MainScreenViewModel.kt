...
class MainScreenViewModel(private val wallsListRepository: WallsListRepository) : ViewModel(),
    CoroutineScope {
    ...
    fun getData() {
        launch {
            _wallsList.value = wallsListRepository.getWallsData()
            Log.i("MainScreenViewModel", "WallsList: ${_wallsList.value}")
        }
    }
}